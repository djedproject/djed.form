...
class TestIntegerField(BaseTestCase):
    ...
    def test_fields_int(self):
        ...
        self.assertRaises(djed.form.Invalid, field.to_form, 'value')

        self.assertIs(field.to_field(''), djed.form.null)
        self.assertEqual(field.to_field('10'), 10)
        self.assertRaises(djed.form.Invalid, field.to_field, 'value')
...
class TestLinesField(BaseTestCase):
    ...
    def test_fields_linesfield(self):
        ...
        self.assertRaises(djed.form.Invalid, field.to_form, 1)

        self.assertIs(field.to_field(''), djed.form.null)
        self.assertEqual(field.to_field('1\n2\n3'), ['1','2','3'])
        self.assertRaises(djed.form.Invalid, field.to_field, 5)
...
class TestVocabularyField(BaseTestCase):
    ...
    def test_ctor_convert_vocabulary(self):
        ...
        self.assertIsInstance(field.vocabulary, djed.form.Vocabulary)
    ...
    def test_voc_factory_mapper(self):
        from djed.form.fields import voc_factory_mapper
        m = mock.Mock()
    ...
    def test_takes_one_arg(self):
        from djed.form.fields import takes_one_arg
        def fn(arg):
            return arg
    ...
    @mock.patch('djed.form.fields.inspect')
    ...
    def test_vocabulary_field(self):
        voc = djed.form.Vocabulary(
            (1, 'one', 'One'),
            (2, 'two', 'Two'),
            (3, 'three', 'Three'))

        self.assertRaises(ValueError, djed.form.VocabularyField, 'test')
        self.assertRaises(
            NotImplementedError,
            djed.form.VocabularyField('test', vocabulary=voc).is_checked,
            voc.get_term(1))

        class MyVocabularyField(djed.form.VocabularyField):
        ...
        field.id = 'test'
        field.form_value = djed.form.null
        field.update_items()
...
class TestBaseChoiceField(BaseTestCase):
    ...
    def test_basechoice(self):
        ...
        self.assertIs(field.extract(), djed.form.null)
        ...
        self.assertRaises(djed.form.Invalid, field.to_form, 10)
        self.assertRaises(djed.form.Invalid, field.to_form, [1, 10])

        self.assertIs(field.to_field(''), djed.form.null)
        self.assertEqual(field.to_field('one'), 1)
        self.assertRaises(djed.form.Invalid, field.to_field, 5)
        self.assertRaises(djed.form.Invalid, field.to_field, ['one','five'])
...
class TestBaseMultiChoiceField(BaseTestCase):
    ...
    def test_basemultichoice(self):
        ...
        field = orig_field.bind(request, '', djed.form.null, {})
        field.update()
...
class TestDateTime(BaseTestCase):
    ...
    def test_to_form_null(self):
        typ = self._makeOne()
        result = typ.to_form(djed.form.null)
        self.assertEqual(result, djed.form.null)
    ...
    def test_to_field_null(self):
        typ = self._makeOne()
        result = typ.to_field(djed.form.null)
        self.assertEqual(result, djed.form.null)
...
class TestFileField(BaseTestCase):
    ...
    def test_validate_null(self):
        ...
        self.assertIsNone(field.validate(djed.form.null))
...
class TestOptionsField(BaseTestCase):
    ...
    def test_ctor(self):
        ...
        self.assertIsInstance(ofield, djed.form.RadioField)
    ...
    def test_to_field_with_defaults(self):
        field = djed.form.OptionsField(
            ...
            defaults=True,
            fields=(djed.form.TextField('name'),
                    djed.form.TextField('address', default='street 123')))
    ...
    def test_validate(self):
        ...
        with self.assertRaises(djed.form.CompositeError) as cm:
            field.validate({})
